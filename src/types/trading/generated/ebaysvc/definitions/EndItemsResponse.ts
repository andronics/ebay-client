...
import { EndItemResponseContainer } from './EndItemResponseContainer.js';

/** ns:EndItemsResponseType */
export interface EndItemsResponse {
    /** xs:dateTime */
    Timestamp?: Date;
    ...
    EndItemResponseContainer?: Array<EndItemResponseContainer>;
}
