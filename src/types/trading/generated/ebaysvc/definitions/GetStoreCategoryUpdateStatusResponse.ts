...
/** ns:GetStoreCategoryUpdateStatusResponseType */
export interface GetStoreCategoryUpdateStatusResponse {
    /** xs:dateTime */
    Timestamp?: Date;
    ...
    /** TaskStatusCodeType|xs:token|Pending,InProgress,Complete,Failed,CustomCode */
    Status?: string;
}
