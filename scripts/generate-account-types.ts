#!/usr/bin/env tsx
/**
 * OpenAPI Type Generation Script for eBay Account API
 *
 * This script:
 * 1. Downloads the eBay Account API OpenAPI spec
 * 2. Generates TypeScript types using openapi-typescript
 * 3. Outputs to src/types/account/generated/
 *
 * Usage:
...
const OPENAPI_FILE = join(OPENAPI_DIR, 'sell_account_v1_oas3.json');
const OUTPUT_DIR = join(ROOT_DIR, 'src', 'types', 'account', 'generated');
...
async function generateTypes(): Promise<void> {
  ...
  // Add header comment
  const header = `// Auto-generated from eBay Account API OpenAPI spec
// Do not edit manually - regenerate with: npm run generate:account
//
// These are the full OpenAPI-generated types for eBay Account API.
// Import via:
//   import type { components, operations } from '@andronics/ebay-client/types/account/generated';
...
async function main(): Promise<void> {
  console.log('=== eBay Account API Type Generation ===\n');
