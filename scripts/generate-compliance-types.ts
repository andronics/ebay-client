#!/usr/bin/env tsx
/**
 * OpenAPI Type Generation Script for eBay Compliance API
 *
 * This script:
 * 1. Downloads the eBay Compliance API OpenAPI spec
 * 2. Generates TypeScript types using openapi-typescript
 * 3. Outputs to src/types/compliance/generated/
 *
 * Usage:
...
const OPENAPI_FILE = join(OPENAPI_DIR, 'sell_compliance_v1_oas3.json');
const OUTPUT_DIR = join(ROOT_DIR, 'src', 'types', 'compliance', 'generated');
...
async function generateTypes(): Promise<void> {
  ...
  // Add header comment
  const header = `// Auto-generated from eBay Compliance API OpenAPI spec
// Do not edit manually - regenerate with: npm run generate:compliance
//
// These are the full OpenAPI-generated types for eBay Compliance API.
// Import via:
//   import type { components, operations } from '@andronics/ebay-client/types/compliance/generated';
...
async function main(): Promise<void> {
  console.log('=== eBay Compliance API Type Generation ===\n');
