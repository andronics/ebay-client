#!/usr/bin/env tsx
/**
 * OpenAPI Type Generation Script for eBay Inventory API
 *
 * This script:
 * 1. Downloads the eBay Inventory API OpenAPI spec
 * 2. Generates TypeScript types using openapi-typescript
 * 3. Outputs to src/types/inventory/generated/
 *
 * Usage:
...
const OPENAPI_FILE = join(OPENAPI_DIR, 'sell_inventory_v1_oas3.json');
const OUTPUT_DIR = join(ROOT_DIR, 'src', 'types', 'inventory', 'generated');
...
async function generateTypes(): Promise<void> {
  ...
  // Add header comment
  const header = `// Auto-generated from eBay Inventory API OpenAPI spec
// Do not edit manually - regenerate with: npm run generate:inventory
//
// These are the full OpenAPI-generated types for eBay Inventory API.
// Import via:
//   import type { components, operations } from '@andronics/ebay-client/types/inventory/generated';
...
async function main(): Promise<void> {
  console.log('=== eBay Inventory API Type Generation ===\n');
